...
class Coords<T extends num> extends Point<T> {
  ...
  int get hashCode => _JenkinsSmiHash.hash3(x, y, z);
}

// Copyright (c) 2016, the Dart project authors.  Please see the FLUTTER_AUTHORS
// file for details. All rights reserved. Use of this source code is governed by
// a BSD-style license that can be found in the LICENSE file.
//
// Original commit in quiver-dart by Justin Fagnani <justinfagnani@google.com>
// https://github.com/google/quiver-dart/commit/28e2805fc323e34ddd81b972745ee5b57cd2058e
