...
///  3. outputs a [RasterTileData], containing the [ImageProvider] created by
///     decoding the tile's image bytes
///
...
@immutable
final class RasterTileLoader<S extends Object>
    implements TileLoader<RasterTileData> {
  ...
  @override
  RasterTileData call(TileCoordinates coordinates, TileLayerOptions options) {
