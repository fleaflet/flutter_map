...
import 'package:flutter_map/src/layer/tile_layer/tile_provider/network/native/image_provider.dart';
...
class NetworkTileProvider extends TileProvider {
  ...
  ///
  /// Changing the configuration whilst caching is already working (after the
  /// first tile has been loaded) is not supported. Changing the configuration
  /// whilst a cache already exists is supported, but changing the
  /// [MapCachingOptions.cacheDirectory] will not remove the old directory.
  ///
  ...
  ImageProvider getImage(TileCoordinates coordinates, TileLayer options) =>
      CachingNetworkTileImageProvider(
