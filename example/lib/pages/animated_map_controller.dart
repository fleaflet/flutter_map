...
class AnimatedMapControllerPageState extends State<AnimatedMapControllerPage>
  ...
  // Note the addition of the TickerProviderStateMixin here. If you are getting
  // an error like 'The class 'TickerProviderStateMixin' can't be used as a
  // mixin because it extends a class other than Object.' in your IDE, you can
  // probably fix it by adding an analysis_options.yaml file to your project
  ...
  void _animatedMapMove(LatLng destLocation, double destZoom) {
    ...
    // different Curves values, although I found fastOutSlowIn to be my
    // favorite.
