...
<table data-view="cards" data-full-width="true"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td>💝 <strong>We now accept one-time donations!</strong></td><td><p>We're extremely grateful for anything you can spare.</p><p>We'll donate 15% of what we receive to the OpenStreetMap Foundation, as a thanks for their excellent work.</p></td><td>For more information, details about benefits, and the link to donate, please see <a data-mention href="supporters.md#support-us">#support-us</a>.</td><td><a href="supporters.md#support-us">#support-us</a></td></tr><tr><td>🏗️ <strong>We're looking for OSS projects and sponsors that want to be advertised!</strong></td><td>All larger/notable open-source (and/or non-profits) projects can apply for a free advertising space, and businesses can also apply for an advertising space.</td><td>For more information, and the links to apply, please see <a data-mention href="./#showcase">#showcase</a>.</td><td><a href="showcase.md">showcase.md</a></td></tr><tr><td>👨‍👩‍👧‍👦 <strong>We're on the hunt for maintainers to join the team!</strong></td><td>Don't worry, we're not going anywhere! However, we think flutter_map has untapped potential, and so we're looking for a couple more maintainers to join the team.</td><td>If you think you'd make a great team member, please see <a data-mention href="credits.md#apply-to-be-a-maintainer">#apply-to-be-a-maintainer</a> for more information.</td><td><a href="credits.md#apply-to-be-a-maintainer">#apply-to-be-a-maintainer</a></td></tr></tbody></table>
